...
const fakeStripe = { checkout: { sessions: { create: async (input: Stripe.Checkout.SessionCreateParams) => { params=input; return {url:'https://checkout.stripe.com/c/pay/cs_test_unit'}; } } } };
Object.defineProperty(stripeModule, 'getStripe', { value: () => fakeStripe, configurable: true });
