...
const meta = {
  ...
  packages: PACKAGES,
  note: 'Generated by scripts/sync-platform-packages.mjs — do not edit by hand.',
};
writeFileSync(
  join(root, 'vendor/.platform-sync-meta.json'),
  `${JSON.stringify(meta, null, 2)}\n`,
);

console.log('\nPlatform packages vendored. package.json should use file:./vendor/<name>.');
console.log('Wrote vendor/.platform-sync-meta.json');
