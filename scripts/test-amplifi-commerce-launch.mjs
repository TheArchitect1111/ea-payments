...
assert.match(offer, /id: 'amplifi_intelligence'/);
assert.match(offer, /priceCents: 5900/);
assert.match(offer, /id: 'amplifi_complete'[\s\S]*allowInlineStripePrice: true/);
assert.match(pricing, /name: 'Social', price: '\$29'/);
assert.match(pricing, /name: 'Intelligence', price: '\$59'/);
assert.match(pricing, /name: 'Complete', price: '\$129'/);
assert.match(pricing, /href: '\/amplifi\/register\?plan=amplifi_social'/);
assert.match(pricing, /href: '\/amplifi\/register\?plan=amplifi_intelligence'/);
assert.match(pricing, /href: '\/amplifi\/register\?plan=amplifi_complete'/);
assert.match(register, /planId/);
