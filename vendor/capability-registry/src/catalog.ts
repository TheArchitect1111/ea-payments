...
export const CAPABILITY_CATALOG: CapabilityManifest[] = [
  ...
  baseFromMap('settings', {
    name: 'Portal Settings',
    description: 'Branding and notification preferences for tenant portals.',
    purpose: 'Launch Edition core — lightweight portal configuration surface.',
    category: 'Platform',
    status: 'Development',
    consumers: ['ea-payments'],
    dependencies: ['authentication', 'organizations'],
    routes: [{ path: '/portal/[slug]/settings' }],
    extractionEffort: 'S',
    riskLevel: 'low',
    recommendedPriority: 'P3',
  }),
  ...
  baseFromMap('client-intake', {
    name: 'Client Intake',
    description: 'End-user intake forms stored in a shared portal form ledger.',
    purpose: 'Capture client goals and contact details inside the portal.',
    category: 'Workflow',
    status: 'Development',
    consumers: ['ea-payments'],
    dependencies: ['authentication', 'organizations'],
    routes: [{ path: '/portal/[slug]/intake' }],
    currentRepositories: ['ea-launch-audit/ea-payments'],
    currentFiles: ['lib/portal-forms/store.ts', 'app/portal/[slug]/intake/page.tsx'],
    extractionEffort: 'S',
    riskLevel: 'low',
    recommendedPriority: 'P2',
  }),
  baseFromMap('applications', {
    name: 'Applications',
    description: 'Public apply flow and staff review queue on the shared form ledger.',
    purpose: 'Let prospects apply and staff track review status.',
    category: 'Workflow',
    status: 'Development',
    consumers: ['ea-payments'],
    dependencies: ['authentication', 'organizations'],
    routes: [
      ...
      { path: '/portal/[slug]/applications' },
    ],
    currentRepositories: ['ea-launch-audit/ea-payments'],
    currentFiles: ['lib/portal-forms/store.ts', 'app/portal/[slug]/applications/page.tsx'],
    extractionEffort: 'S',
    riskLevel: 'low',
    recommendedPriority: 'P2',
  }),
  baseFromMap('operations-reports', {
    name: 'Operations Reports',
    description: 'Curated gallery of Pulse, CTP BI, and document reports.',
    purpose: 'Give clients one calm place for operational insights.',
    category: 'Analytics',
    status: 'Development',
    consumers: ['ea-payments'],
    dependencies: ['authentication', 'pulse'],
    routes: [{ path: '/portal/[slug]/reports' }],
    currentRepositories: ['ea-launch-audit/ea-payments'],
    currentFiles: ['lib/portal-reports.ts', 'app/portal/[slug]/reports/page.tsx'],
    extractionEffort: 'S',
    riskLevel: 'low',
    recommendedPriority: 'P3',
  }),
