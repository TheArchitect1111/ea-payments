...
export const storyScenes: StoryScene[] = [
  {
    ...
    current: 'Your organization has become harder to run.',
    possible: 'One connected place gives the work room to breathe.',
    story: 'A founder moves from scattered updates, repeated questions, and late-night dependency into one calmer operating rhythm.',
    currentImage: storyImage('photo-1516321497487-e288fb19713f'),
    possibleImage: storyImage('photo-1763631045896-04d2e60048ae'),
    currentAlt: 'A business owner working alone late at night while family life continues without them',
    possibleAlt: 'A multigenerational family walking together outdoors with unhurried time for each other',
  ...
  },
  {
    ...
    currentImage: storyImage('photo-1577563908411-5077b6dc7624'),
    possibleImage: storyImage('photo-1518611012118-696072aa579a'),
  ...
  },
  {
    ...
    currentImage: storyImage('photo-1552664730-d307ca884978'),
    possibleImage: storyImage('photo-1522202176988-66273c2fd55f'),
    currentAlt: 'An experienced nonprofit leader repeating the same training for a new volunteer',
  ...
  },
  {
    ...
    currentImage: storyImage('photo-1487412720507-e7ab37603c6f'),
  ...
  },
  {
    ...
    possibleImage: storyImage('photo-1600880292203-757bb62b4baf'),
  ...
  },
  {
    ...
    currentImage: storyImage('photo-1553877522-43269d4ea984'),
    possibleImage: storyImage('photo-1559027615-cd4628902d4a'),
    currentAlt: 'A leader buried in operational work while community opportunities wait unattended',
    possibleAlt: 'A racially diverse volunteer team serving their community with visible, hands-on impact',
...
export const futureSegments = {
  school: {
    ...
    image: storyImage('photo-1503676260728-1c00da094a0b', 1200),
  ...
  church: {
    ...
    image: storyImage('photo-1760367121593-97b9a02bbd65', 1200),
  ...
  business: {
    ...
    image: storyImage('photo-1542744173-8e7e53415bb0', 1200),
