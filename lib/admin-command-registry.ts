...
export const ADMIN_COMMANDS: CommandItem[] = [
  { id: 'nav-master', label: 'Executive Home', group: 'Navigate', href: '/admin/master', keywords: ['home', 'dashboard', 'brief', 'master', 'morning'] },
  { id: 'nav-executive-factory', label: 'Executive Factory', group: 'Navigate', href: '/admin/factory', keywords: ['create', 'factory', 'accomplish', 'opportunity', 'understand', 'plan', 'build'] },
  ...
  { id: 'nav-ctp', label: 'CTP Submissions', group: 'Navigate', href: '/admin/ctp', keywords: ['ctp', 'intake', 'submissions', 'consider'] },
  { id: 'nav-pipeline', label: 'Pipeline Dashboard', group: 'Navigate', href: '/admin/dashboard', keywords: ['assessments', 'administration', 'pipeline'] },
  ...
  { id: 'nav-capabilities', label: 'Capability Marketplace', group: 'Navigate', href: '/admin/capability-marketplace', keywords: ['capabilities', 'entitlements', 'platform'] },
  { id: 'nav-foundation-library', label: 'Foundation Library', group: 'Navigate', href: '/admin/foundation-library', keywords: ['legacy library redirect', 'knowledge', 'templates'] },
  ...
  { id: 'nav-twin', label: 'Digital Twin', group: 'Navigate', href: '/admin/digital-twin', keywords: ['mirror', 'health', 'platform', 'legacy redirect'] },
  { id: 'nav-marketplace', label: 'Partner Marketplace', group: 'Navigate', href: '/admin/partner-marketplace', keywords: ['partner', 'referral', 'cpr'] },
  { id: 'nav-launch-readiness', label: 'Launch readiness', group: 'Navigate', href: '/launch', keywords: ['command center', 'readiness', 'ops'] },
