...
export const ADMIN_COMMANDS: CommandItem[] = [
  ...
  { id: 'nav-decisions', label: 'Decision Intelligence', group: 'Navigate', href: '/admin/decisions', keywords: ['decisions', 'approvals', 'triage'] },
  { id: 'nav-search', label: 'Universal Search', group: 'Navigate', href: '/admin/search', keywords: ['find', 'discover', 'search'] },
  ...
  { id: 'nav-knowledge-center', label: 'Knowledge Center', group: 'Navigate', href: '/admin/knowledge', keywords: ['templates', 'prompts', 'automations', 'library', 'sops', 'policies'] },
  { id: 'nav-foundation-library', label: 'Foundation Library', group: 'Navigate', href: '/admin/foundation-library', keywords: ['legacy library redirect'] },
  ...
  { id: 'nav-atlas', label: 'Atlas', group: 'Navigate', href: '/admin/atlas', keywords: ['relationships', 'dependencies', 'ecosystem', 'map'] },
