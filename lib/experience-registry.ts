...
export const CAPABILITY_REGISTRY: CapabilityDefinition[] = [
  ...
  },
  {
    id: 'shared-calendar',
    moduleId: 'calendar',
    customerGoal: 'Coordinate shared dates and availability',
    plainLanguage: 'Shared calendar',
    eaCapability: 'Connected Calendar',
    displayLabel: 'EA Shared Calendar™',
    disclosureLevel: 'L2',
    navGroup: 'operations',
    showInSidebar: true,
    showInPillNav: false,
  ...
  },
  {
    id: 'events',
    moduleId: 'events',
    customerGoal: 'Coordinate appointments and events',
    plainLanguage: 'Calendar & events',
    eaCapability: 'Shared Scheduling & Events',
    displayLabel: 'Calendar & Event Hub™',
    disclosureLevel: 'L3',
    navGroup: 'operations',
    showInSidebar: true,
    showInPillNav: false,
