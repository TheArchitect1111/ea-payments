...
export const CAPABILITY_REGISTRY: CapabilityDefinition[] = [
  ...
  },
  {
    ...
    plainLanguage: 'Project updates',
    eaCapability: 'Curated project updates',
    displayLabel: 'Project Updates',
  ...
  },
  {
    id: 'messaging',
    moduleId: 'messaging',
    customerGoal: 'Contact your guide',
    plainLanguage: 'Contact your guide',
    eaCapability: 'Guide contact',
