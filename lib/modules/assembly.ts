...
import { certificationAuthority } from '@/lib/modules/certification-authority';
import {
...
export type AssemblyRejection = {
  id: string;
  reason: 'unknown-module' | 'not-certified' | 'cost-license-not-approved' | 'missing-10-class-certificate';
