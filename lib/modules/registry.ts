...
const TECHNICAL_MODULE_REGISTRY: TechnicalModuleDefinition[] = [
  ...
  },
  {
    ...
    tag: 'Amplifi™',
    title: 'Amplify & share',
    description: 'Draft social posts from Magnifi stories and view your amplification narrative — not an automated research engine.',
    variant: 'amplifi',
    requiredRole: 'guest',
    pathSegment: 'amplifi',
  },  {
    ...
    description: 'Curated published updates and structured requests — not a chat product.',
    requiredRole: 'guest',
    pathSegment: 'updates',
  },
  {
    ...
    description: 'Email your guide — not an in-app inbox.',
    requiredRole: 'guest',
