...
const TECHNICAL_MODULE_REGISTRY: TechnicalModuleDefinition[] = [
  ...
  {
    id: 'calendar',
    name: 'EA Shared Calendar™',
    tag: 'Calendar',
    title: 'Shared calendar',
    description: 'Google, Microsoft, iCloud, and Exchange calendars connected through Nylas.',
    requiredRole: 'guest',
    pathSegment: 'calendar',
  },
  {
    id: 'events',
    name: 'Calendar & Event Hub™',
    tag: 'Calendar & Events',
    title: 'Calendar & shared scheduling',
    description:
      'Shared scheduling, advisor bookings, events, ticketing, and registrations in one hub.',
    requiredRole: 'guest',
    pathSegment: 'events',
  },
  {
