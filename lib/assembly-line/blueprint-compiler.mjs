const MODULES = {
  ...
  media: { capabilities: ['files','roles-permissions'], route: '/media', label: 'Media' },
  calendar: { capabilities: ['calendar','notifications'], route: '/calendar', label: 'Calendar' },
  eva: { capabilities: ['messaging','workflow','tenant-data'], route: '/eva', label: 'Eva' },
