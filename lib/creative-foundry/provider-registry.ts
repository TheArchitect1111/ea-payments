...
export function getCreativeProviderRegistry(): CreativeProviderCapability[] {
  return [
    ...
    },
    {
      ...
      commercialSafe: true,
      notes: "Workflow orchestrator. Individual model licenses must still be checked.",
    },
    {
      provider: "stability",
      kind: "image-generation",
      ...
      commercialSafe: true,
      notes: "Preferred commercial image-generation provider when configured.",
    },
    {
      provider: "satori-resvg",
      kind: "layout-rendering",
      enabled: envEnabled("CREATIVE_SATORI_RESVG_ENABLED"),
      commercialSafe: true,
      notes: "Deterministic typography and social graphic rendering target.",
    },
    {
      provider: "fabric",
      kind: "layout-rendering",
