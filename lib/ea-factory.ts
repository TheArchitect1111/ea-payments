...
export const EA_FACTORY_PROTOCOLS: EAFactoryProtocol[] = [
  ...
  },
  {
    ...
    approvedBy: 'EA Founder',
    approvalStatus: 'active',
    futureNotes: 'Wire workspace auto-provisioning and Creative Studio studio lifecycle hooks.',
    ...
    governs: [
      ...
      'review scheduling',
      'Pulse ctp.submitted events',
    ],
    approvalRequired: true,
    versionHistory: [{ version: '1.0.0', status: 'active', notes: 'Initial CTP operational protocol — submissions table + Pulse integration.' }],
  },
  {
    id: 'ea-training',
