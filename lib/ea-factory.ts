...
export const EA_FACTORY_PROTOCOLS: EAFactoryProtocol[] = [
  ...
  },
  {
    ...
    approvedBy: 'EA Founder',
    approvalStatus: 'active',
    futureNotes: 'Add specialist agent roster (motion, accessibility, photography direction).',
    tags: ['open-design', 'creative', 'story', 'experience', 'art-direction'],
    purpose:
      'Governs the Creative Experience Engine — story extraction, creative DNA, experience design, and Cursor handoff. Never operational analysis.',
    governs: [
      'story gate',
      'creative DNA',
      'homepage and portal concepts',
      'Mission Control creative status',
      'Cursor output contract',
    ],
    approvalRequired: true,
    versionHistory: [{ version: '1.0.0', status: 'active', notes: 'Integrated per OPEN-DESIGN-ARCHITECTURE.md.' }],
  },
  {
    id: 'ea-praison-ai',
    name: 'EA PraisonAI Workforce Protocol',
    ...
    approvedBy: 'EA Founder',
    approvalStatus: 'active',
    futureNotes: 'Add Legal, Compliance, Grant Writer, HR, Cybersecurity agents via workforce registry.',
    tags: ['praison-ai', 'workforce', 'executive-intelligence', 'agents', 'orchestration'],
    purpose:
      'Governs the AI intelligence workforce — specialist agents, QA gate, executive summary, knowledge graph, and Make.com handoff.',
    governs: [
      'workforce registry',
      ...
      'Make.com package webhook',
    ],
    approvalRequired: true,
    versionHistory: [{ version: '1.0.0', status: 'active', notes: 'Integrated per PRAISONAI-ARCHITECTURE.md.' }],
  },
  {
  ...
  },
  {
    ...
    governs: [
      ...
      'Creative Studio auto-campaign bridge',
      'discovery asset upload pipeline',
      'logo-to-brand-profile bridge',
      'studio ready-for-review automation',
      'admin CTP asset viewer',
      'portal asset gallery',
      'collaborative review scheduling',
    ],
    approvalRequired: true,
    versionHistory: [
      { version: '1.8.0', status: 'active', notes: 'Portal discovery asset gallery and admin review scheduling with ctp.review.scheduled Pulse event.' },
      { version: '1.7.0', status: 'active', notes: 'Admin CTP submissions page and discovery asset viewer on proposals dashboard.' },
      { version: '1.6.0', status: 'active', notes: 'Sync CTP logo uploads to Creative Studio brand profile; auto-advance to Ready For Review when campaign package completes.' },
      { version: '1.5.0', status: 'active', notes: 'Real asset uploads on Discover wizard; manifest persisted on CTP submission with Creative Studio chunk storage.' },
      { version: '1.4.0', status: 'active', notes: 'Auto-create Creative Studio campaign from CTP submission with ctp.studio.started Pulse event.' },
