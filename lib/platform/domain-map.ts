...
export const CLIENT_DOMAIN_BINDINGS: ClientDomainBinding[] = [
  ...
  },
  {
    ...
    slug: 'cpr',
    // Quarantine: do NOT rewrite to EA /portal/cpr (wrong login for families).
    // Until CPR cutover, this host should not be advertised. Binding reserved.
    surface: 'site',
    label: 'QUARANTINED — use CPR family login on canadianprospectrecruitment.vercel.app',
  },
  {
