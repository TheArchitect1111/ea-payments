/**
 * Server-only data loader for Capability Marketplace admin page.
 * Returns serializable DTOs only — no client components, no Playwright, no media.
 */
import {
...
export function loadCapabilityMarketplacePageData() {
