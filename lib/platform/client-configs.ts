...
export const PLATFORM_CLIENT_CONFIGS: Record<string, PlatformClientConfig> = {
  ...
  cpr: {
    ...
    terminology: {
      members: 'Players',
      startPrompt: 'What would you like to create for your players or families?',
      aiAdvisor: 'Recruiting Advisor',
    },
  },
  etfm: {
    id: 'etfm',
    ...
    themeId: 'etfm-theme',
    enabledModuleKeys: ['training', 'updateHub', 'connections', 'amplifi'],
  ...
  church: {
    ...
    name: 'Church Portal',
    workspaceName: 'Church Operating Center',
    personalityId: 'executive',
    themeId: 'ea-default-theme',
    enabledModuleKeys: ['updateHub', 'training', 'events', 'documents', 'connections', 'amplifi'],
    plannedModuleKeys: [],
    terminology: {
      members: 'Members',
      startPrompt: 'What ministry or congregational outcome should we advance?',
    },
  },
  coach: {
    id: 'coach',
    organizationId: 'coach',
    name: 'Coach Portal',
    workspaceName: 'Coaching Workspace',
    personalityId: 'athletics',
    themeId: 'cpr-theme',
    enabledModuleKeys: ['updateHub', 'training', 'events', 'documents', 'connections', 'amplifi'],
    plannedModuleKeys: [],
    terminology: {
      members: 'Athletes',
      startPrompt: 'What coaching outcome should we build next?',
    },
  },
  nonprofit: {
    id: 'nonprofit',
    ...
    workspaceName: 'Nonprofit Command Center',
    personalityId: 'operations',
    themeId: 'ea-default-theme',
    enabledModuleKeys: ['updateHub', 'training', 'events', 'documents', 'connections', 'amplifi'],
    plannedModuleKeys: [],
    terminology: {
      members: 'Supporters',
      startPrompt: 'What mission outcome should we support today?',
    },
  },
  'small-business': {
    id: 'small-business',
    organizationId: 'small-business',
    name: 'Small Business Portal',
    workspaceName: 'Business Operating Hub',
    personalityId: 'executive',
    themeId: 'ea-default-theme',
    enabledModuleKeys: ['updateHub', 'training', 'events', 'documents', 'connections', 'amplifi'],
    plannedModuleKeys: [],
    terminology: {
      members: 'Clients',
      startPrompt: 'What customer or growth outcome should we move forward?',
    },
  },
  association: {
    id: 'association',
    organizationId: 'association',
    name: 'Association Portal',
    workspaceName: 'Association Workspace',
    personalityId: 'operations',
    themeId: 'ea-default-theme',
    enabledModuleKeys: ['updateHub', 'training', 'events', 'documents', 'connections', 'amplifi'],
    plannedModuleKeys: [],
    terminology: {
      members: 'Members',
      startPrompt: 'What member or chapter outcome should we advance?',
    },
  },
};
