...
import { CPR_FAMILY_LOGIN_URL } from '../cpr-canonical';
...
export const cprAthleticsContentPack: VerticalContentPack = {
  ...
  summary:
    'Faith · Family · Basketball · Future — player pathways, parent guide, Connect nurture. Family login stays on the live CPR portal (not EA /portal/cpr).',
  apply(base, ctx) {
    // Do NOT use /portal/{slug} for CPR team login — that is the EA chassis preview.
    const portal = CPR_FAMILY_LOGIN_URL;
    ...
    return {
      ...
      nav: [
        ...
        { label: 'Family login', href: portal },
      ...
      difference: {
        ...
        subheading:
          'Landing + Connect nurture on EA; live family login on the CPR portal — one story, correct doors.',
        cards: [
          {
      ...
      process: {
        ...
        steps: [
          ...
          {
            label: 'Evaluate',
            description: 'Athlete evaluation, film, and profile updates land in the CPR family portal.',
            icon: 'trackicon',
          },
          {
            label: 'Advance',
      ...
      results: {
        ...
        profileCta: 'Family portal login',
        profileHref: portal,
      },
      founder: {
        ...
        story:
          'CPR exists so every prospect gets seen — and every family understands the pathway. Faith. Family. Basketball. Future. Live family login stays on the CPR portal; this landing is the recruiting front door.',
        image: CPR_ASSETS.hustle,
      },
      finalCta: {
        heading: 'Ready for the next recruiting conversation?',
        subheading:
          'Get the Parent Recruiting Guide now — explore programs — or sign in to the CPR family portal if you already train with CPR.',
        applyLabel: 'Get the Parent Recruiting Guide',
      ...
      footer: {
        ...
        quickLinks: [
          { label: 'Family portal login', href: portal },
