        ...
        try {
          ...
          if (signal) {
            data = {
              ...
              whoTheyAre: signal.whoTheyAre || null,
              whatTheyDo: signal.whatTheyDo || null,
              audience: signal.audience || null,
              offer: signal.offer || signal.whatTheyDo || null,
              voice: signal.voice || null,
              proof: signal.proof || null,
              friction: signal.friction || null,
              opsClue: signal.opsClue || null,
              primaryColor: signal.primaryColor || null,
              accentColor: signal.accentColor || null,
