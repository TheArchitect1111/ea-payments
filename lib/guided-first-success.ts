...
export const GUIDED_PLATFORMS: Record<EAPlatformId, GuidedPlatformConfig> = {
  portal: {
    ...
    resultDetail: 'Open Simplifi capture or explore the Selena Magnifi demo — your Action Center will track what matters.',
    nextActions: [
  ...
  simplifi: {
    id: 'simplifi',
    name: 'Simplifi™',
    tagline: 'Capture anything. Understand it. Act on it.',
    successLooksLike: 'Your first capture is analyzed and a Magnifi experience is ready to share.',
    intents: [
    ...
    firstActionLabel: 'Capture your first item',
    resultTitle: 'Ready to capture',
    resultDetail: 'Tap Capture — paste a URL or upload a screenshot. Magnifi builds automatically in the background.',
    nextActions: [
      { id: 'capture', label: 'Capture now' },
      { id: 'plan', label: 'Plan a follow-up' },
      { id: 'save', label: 'Save for later with purpose' },
      { id: 'share', label: 'Share via Amplifi' },
    ],
    coachPrompts: ['What should I capture?', 'How does Magnifi work?', 'What do I do after capture?'],
  },
  magnifi: {
    id: 'magnifi',
    name: 'Magnifi™',
