...
export const amandaWebsitePreview: AmandaWebsiteProps = {
  ...
  paths: [
    ...
    { number: '02', script: 'Heal', label: 'Aesthetikine', body: 'Wellness services and holistic care for mind, body, and spirit.', href: '#', image: '/images/ctp-editorial/05-calm-morning-owner.png' },
    { number: '03', script: 'Learn', label: 'The Entrepreneurial Artist', body: 'Books, courses, and practical tools to turn talent into opportunity.', href: '#', image: '/images/ctp-editorial/10-clarity-blueprint-planning.png' },
    { number: '04', script: 'Speak', label: 'Speaking & Events', body: 'Keynotes, workshops, and transformative conversations.', href: '#', image: '/home/he-hero-live.jpg' },
    { number: '05', script: 'Partner', label: 'Strategic Partnerships', body: 'Collaborate on impact-driven projects and initiatives.', href: '#', image: '/images/ctp-editorial/06-capacity-team-collaboration.png' },
    { number: '06', script: 'Begin', label: 'Not sure where to start?', body: 'Answer a few questions and receive a personalized path.', href: '#', image: '/images/ctp-editorial/11-momentum-designed-future.png' },
  ],
