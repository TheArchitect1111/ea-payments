...
test('amplifi landing page is reachable', async ({ page }) => {
  ...
  await expect(page.getByRole('heading', { name: /complete content team/i })).toBeVisible();
  await expect(page.getByText(/smartchitecture \+ eva intelligence/i)).toBeVisible();
