...
const images = {
  hero: '/otis-nixon/hero.webp',
  legacyBar: '/otis-nixon/legacy-bar.webp',
  ...
  return <main className="otis-site">
    <div className="shell">
      ...
      <section id="book" className="book-feature">
        <div className="book-photo"><img src={images.book} alt="Keeping It Real by Otis Nixon book cover"/></div>
