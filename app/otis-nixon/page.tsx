  ...
  return <main className="otis-site">
    <div className="shell">
      ...
      <section id="top" className="hero-image-first">
        <img src={images.hero} alt="Otis Nixon as player, speaker and minister" width="1536" height="1024" decoding="sync"/>
      </section>
      ...
      <section id="book" className="book-feature">
        <div className="book-photo"><img src={images.book} alt="Keeping It Real by Otis Nixon book cover" width="992" height="1536" decoding="sync"/></div>
      ...
      <section className="legacy-bar"><img src={images.legacyBar} alt="Otis Nixon life and legacy collage" width="1536" height="614" decoding="sync"/></section>
