...
export default function VoiceAssistant() {
  ...
  const executeIntent = useCallback((result: VoiceIntent) => {
    setIntent(result);
  ...
  const submit = async (text?: string) => {
    ...
    try {
      ...
      const data = (await res.json()) as { ok?: boolean; intent?: VoiceIntent };
      if (data.intent) {
        setQuery(q);
        ...
        >
          ...
          >
            ...
            <p className="text-xs text-neutral-500 mb-4">
              Try: &quot;Open Resource Radar&quot;, &quot;Run Simplifi audit on https://…&quot;, &quot;Search graph for Magnifi&quot;
            </p>
            ...
            {intent && (
              <div className="space-y-3">
                ...
                <TrustPanel
                  ...
                  method="EA Voice intent router + optional Claude enhancement"
