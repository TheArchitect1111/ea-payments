    ...
    <div className="mx-auto flex min-h-[100dvh] w-full max-w-md flex-col gap-6 px-4 py-8">
      <header className="space-y-1">
        ...
        <p className="text-sm leading-relaxed text-[#4a5568]">
          Only a business name is required. Everything else is optional.
        </p>
      </header>
      ...
      <form onSubmit={onProvision} className="flex flex-col gap-3">
        ...
        <label className="flex flex-col gap-1.5">
          <span className="text-sm font-medium text-[#1a2332]">Contact name (optional)</span>
          <input
            type="text"
            value={contactName}
        ...
        <label className="flex flex-col gap-1.5">
          <span className="text-sm font-medium text-[#1a2332]">Email (optional)</span>
          <input
            type="text"
            value={email}
        ...
        <label className="flex flex-col gap-1.5">
          <span className="text-sm font-medium text-[#1a2332]">Current website / link (optional)</span>
          <input
            type="text"
            value={websiteUrl}
        ...
        <label className="flex flex-col gap-1.5">
          <span className="text-sm font-medium text-[#1a2332]">Image / logo URL (optional)</span>
          <input
            type="text"
            value={imageUrl}
        ...
        <label className="flex flex-col gap-1.5">
          <span className="text-sm font-medium text-[#1a2332]">Industry (optional)</span>
          <input
            type="text"
            value={industry}
        ...
        <label className="flex flex-col gap-1.5">
          <span className="text-sm font-medium text-[#1a2332]">Notes / ideas (optional)</span>
          <textarea
            value={notes}
