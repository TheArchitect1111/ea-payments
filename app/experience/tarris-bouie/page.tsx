...
const tiles = [
  ...
  ['BRAND','TB3 is bigger than basketball.','EXPLORE THE BRAND','nil-brand','07-spire-closeup.jpg'],
...
export default function TarrisBouieExperience(){
 return <main className="tb3-site">
  <header className="tb3-site-nav">
   ...
   <Link className="tb3-site-redbtn" href="/hq">ENTER TB3 HQ →</Link>
  </header>
  <section id="home" className="tb3-site-hero">
   ...
   <div className="tb3-site-hero-copy"><div className="tb3-site-giant">TB<span>3</span></div><p className="tb3-site-more">MORE THAN A GAME</p><div className="tb3-site-actions"><a className="tb3-site-redbtn" href="#media">▶ WATCH THE STORY</a><Link className="tb3-site-outline" href="/hq">ENTER TB3 HQ →</Link></div></div>
   <img className="tb3-site-hero-person" src={asset+'/verified-tarris-hoodie-front.jpg'} alt="Tarris Bouie"/>
