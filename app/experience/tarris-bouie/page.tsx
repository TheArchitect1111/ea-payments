...
const asset = '/assets/tarris/2026-09-01';
const tiles = [
  ['ATHLETE','Game. Skills. Growth. A higher level.','LEARN MORE','journey','journey-action.avif'],
  ['STORY','The journey. The mindset. The why.','READ HIS STORY','journey','journey-portrait.avif'],
  ['BRAND','TB3 is bigger than basketball.','EXPLORE THE BRAND','nil-brand','close.avif'],
  ['NIL','Opportunities. Partnerships. Impact.','NIL INQUIRIES','opportunities','audience.avif'],
  ['COMMUNITY','Investing in the next generation.','SEE THE IMPACT','community','community.avif'],
] as const;
...
export default function TarrisBouieExperience(){
 return <main className="tb3-site">
  ...
  <section id="home" className="tb3-site-hero">
   ...
   <img className="tb3-site-hero-person" src={asset+'/hero.avif'} alt="Tarris Bouie"/>
  ...
  <section id="media" className="tb3-site-media"><div><p className="tb3-site-eyebrow">MEDIA</p><h2>HIGHLIGHTS.<br/>INTERVIEWS.<br/>MORE TO COME.</h2><p>Get an inside look at Tarris on and off the court. Game highlights, interviews, training, community and exclusive content.</p><Link className="tb3-site-redbtn" href="/portal/tarris-bouie/media">WATCH NOW →</Link></div><Link className="tb3-site-feature" href="/portal/tarris-bouie/media"><img src={asset+'/film.avif'} alt="The Journey Continues"/><span>▶</span></Link><div className="tb3-site-playlist">Game Highlights<br/>Interview: The Mindset<br/>Training Day<br/>Community Impact<br/><Link href="/portal/tarris-bouie/media">VIEW ALL VIDEOS →</Link></div></section>
  <section className="tb3-site-future"><article id="enterprise"><div><h2>ENTERPRISE</h2><p>Business. Education.<br/>Long-term opportunities.</p><Link href="/portal/tarris-bouie/opportunities">LEARN MORE →</Link></div><img src={asset+'/lifestyle.avif'} alt="Tarris Bouie enterprise"/></article><article id="future"><div><h2>THE FUTURE</h2><p>More than a player.<br/>A platform for what’s next.</p><Link href="/portal/tarris-bouie/journey">SEE THE VISION →</Link></div><img src={asset+'/close.avif'} alt="Tarris Bouie future"/></article><article className="tb3-site-playerone"><h2>PLAYER ONE</h2><p>A student. An athlete. A brand.<br/>A platform. The next chapter starts now.</p><Link className="tb3-site-outline tb3-site-light" href="/portal/login?next=/portal/tarris-bouie">ENTER TB3 HQ →</Link></article></section>
  <section id="merch" className="tb3-site-store"><div><h2>TB<span>3</span> STORE</h2><b>WEAR THE VISION</b><p>Premium gear for a bigger purpose.<br/>Rep TB3 and be part of the journey.</p><Link className="tb3-site-redbtn" href="/portal/tarris-bouie/store">SHOP TB3 →</Link></div><img src={asset+'/journey-action.avif'} alt="TB3 collection"/><aside>HOODIES<br/>TEES<br/>HATS<br/>AND MORE</aside></section>
