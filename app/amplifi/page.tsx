...
export default function Page() {
  return (
    <main className="a4">
      <style>{`
        .a4 .flow-break{padding:34px 7vw;background:#0a1220;color:#fff;display:flex;align-items:center;justify-content:space-between;gap:24px;border-top:1px solid #1f3148;border-bottom:1px solid #1f3148}.a4 .flow-break b{font:700 clamp(24px,3vw,42px)/1.05 Georgia,serif;max-width:760px}.a4 .flow-break span{font-size:10px;letter-spacing:.16em;color:#65d8c9;font-weight:900}.a4 .audience-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:16px;margin-top:38px}.a4 .audience-card{min-height:260px;border-radius:26px;padding:22px;color:#fff;display:flex;flex-direction:column;justify-content:flex-end;position:relative;overflow:hidden;background:linear-gradient(160deg,#0a1220,#293951)}.a4 .audience-card:before{content:'';position:absolute;inset:0;background:radial-gradient(circle at 75% 18%,rgba(101,216,201,.28),transparent 24%),radial-gradient(circle at 20% 80%,rgba(101,77,228,.38),transparent 32%)}.a4 .audience-card>*{position:relative;z-index:2}.a4 .audience-card small{color:#65d8c9;font-size:9px;letter-spacing:.14em;font-weight:900}.a4 .audience-card h3{font:700 24px/1.08 Georgia,serif;margin:8px 0 0}.a4 .clarity-callout{max-width:1080px;margin:34px auto 0;padding:28px;border-radius:28px;background:#fff;border:1px solid #dedbd4;display:grid;grid-template-columns:auto 1fr;gap:20px;align-items:center;box-shadow:0 18px 45px rgba(20,25,40,.08)}.a4 .clarity-num{width:68px;height:68px;border-radius:20px;background:#654de4;color:#fff;display:flex;align-items:center;justify-content:center;font-size:28px;font-weight:900}.a4 .clarity-callout h3{font:700 28px/1.08 Georgia,serif;margin:0 0 8px}.a4 .clarity-callout p{margin:0;color:#5b6675;line-height:1.55}.a4 .smart-flow{grid-template-columns:repeat(5,1fr)!important}.a4 .smart-flow>div{position:relative}.a4 .smart-flow>div:not(:last-child):after{content:'→';position:absolute;right:-18px;top:50%;transform:translateY(-50%);color:#65d8c9;font-size:22px}.a4 .legal-strip{background:#f0eee8;padding:48px 7vw;border-top:1px solid #dedbd4}.a4 .legal-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:18px;max-width:1180px;margin:auto}.a4 .legal-card{background:#fff;border:1px solid #dedbd4;border-radius:22px;padding:22px}.a4 .legal-card small{font-size:9px;letter-spacing:.13em;color:#654de4;font-weight:900}.a4 .legal-card h3{font:700 22px Georgia,serif;margin:8px 0}.a4 .legal-card p{font-size:12px;line-height:1.55;color:#66717f;margin:0}.a4 .standout{background:#654de4;color:#fff;padding:52px 7vw;text-align:center}.a4 .standout span{display:block;font-size:10px;letter-spacing:.15em;color:#dcd7ff;font-weight:900}.a4 .standout h2{max-width:900px;margin:12px auto 0;font:700 clamp(38px,5vw,70px)/1 Georgia,serif}.a4 .standout p{max-width:760px;margin:18px auto 0;color:#f0edff;font-size:16px;line-height:1.6}.a4 .story-photo>div{max-width:720px}.a4 .story-photo b{line-height:1.18}.a4 .search-ui{overflow:visible}.a4 .search-query,.a4 .insight-stack article{background:#fff;border-radius:20px}.a4 .insight-stack{display:grid;gap:12px;padding:18px}.a4 .insight-stack article{border:1px solid #ece7e1;padding:22px}.a4 .insight-stack article:first-child{background:#0a1220;color:#fff}.a4 .insight-stack article:first-child p{color:#d7dee7}.a4 .section-label{display:inline-flex;align-items:center;gap:8px;background:#e8e3ff;color:#654de4;border-radius:999px;padding:8px 12px;font-size:9px;font-weight:900;letter-spacing:.12em}.a4 .section-label:before{content:'✦';font-size:11px}@media(max-width:900px){.a4 .audience-grid,.a4 .legal-grid{grid-template-columns:1fr 1fr}.a4 .smart-flow{grid-template-columns:1fr!important}.a4 .smart-flow>div:not(:last-child):after{content:'↓';right:auto;left:50%;top:auto;bottom:-24px;transform:translateX(-50%)}.a4 .flow-break{align-items:flex-start;flex-direction:column}}@media(max-width:620px){.a4 .audience-grid,.a4 .legal-grid{grid-template-columns:1fr}.a4 .clarity-callout{grid-template-columns:1fr}.a4 .clarity-num{width:54px;height:54px}.a4 .flow-break{padding:28px 22px}.a4 .standout{padding:44px 22px}}
      `}</style>
