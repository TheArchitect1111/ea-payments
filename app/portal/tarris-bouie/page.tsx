  ...
  return <main className="tb3-app">
    ...
    <section className="tb3-workspace">
      ...
      <section className="tb3-hero">
        ...
        <div className="tb3-athlete-art"><span className="tb3-number">4</span><img className="tb3-athlete-photo" src="/assets/tarris/authentic/09-alabama-portrait-cutout.png" alt="Tarris Bouie"/></div>
      ...
      <section className="tb3-dashboard">
        <Link className="tb3-card tb3-feature" href="/portal/tarris-bouie/journey"><img className="tb3-card-bg" src="/assets/tarris/authentic/03-spire-drive-horizontal.jpg" alt="Tarris Bouie game highlight"/><span className="tb3-label">FEATURED VIDEO</span><div className="tb3-video-mark">▶</div><h2>THE<br/>JOURNEY<br/>CONTINUES.</h2><small>ALABAMA · 4</small></Link>
        ...
        <article className="tb3-card tb3-media"><header><span>RECENT MEDIA</span><Link href="/portal/tarris-bouie/media">View All →</Link></header><div>{media.map(([title,time],i)=><Link href="/portal/tarris-bouie/media" key={title}><span className={`tb3-thumb tone-${i}`}><img src={["/assets/tarris/authentic/03-spire-drive-horizontal.jpg","/assets/tarris/authentic/verified-tarris-training-fullbody.jpg","/assets/tarris/authentic/07-spire-closeup-cutout.png","/assets/tarris/authentic/04-basketball-camp-community.png"][i]} alt=""/><b>▶</b></span><strong>{title}</strong><small>{time}</small></Link>)}</div></article>
        ...
        <Link className="tb3-card tb3-eva" href="/portal/tarris-bouie/eva"><span className="tb3-eva-face"><img src="/assets/tarris/authentic/verified-tarris-hoodie-front.jpg" alt="Eva assistant"/>EVA</span><div><h3>ASK EVA</h3><p>Your AI Assistant</p><ul><li>Get answers</li><li>Update content</li><li>Track opportunities</li><li>Manage requests</li></ul><b>CHAT WITH EVA →</b></div></Link>
        <Link className="tb3-card tb3-tomorrow" href="/portal/tarris-bouie/journey"><img className="tb3-card-bg" src="/assets/tarris/authentic/09-alabama-next-chapter.png" alt="Tarris Bouie future"/><div><h3>A GREATER<br/>TOMORROW.</h3><p>STUDENT. ATHLETE. BRAND.<br/>A PLATFORM. A GENERATION.</p></div><strong>4</strong></Link>
